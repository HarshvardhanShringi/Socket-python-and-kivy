...
class MenuScreen(Screen):
    ...
    def scket(self):
        ...
        c.sendto(bytes(name_, 'utf-8'),(ip,int(port)))
    ...
    def pressed(self, instance):
        global ip,port,passs1,name_,pas
        ...
        print("IP Address:", ip, "Port no:", port, "Name:", name_,"Password",passs1)
        self.scket()
...
class SettingsScreen(Screen):
    ...
    def sending(self,instance):
        ...
        c.sendto(bytes(msg, 'utf-8'), (ip, int(port)))
